    ...
    def _show_step_2_investor(self):
        ...
        with st.container():
            ...
            **37,000名受害者**，遍及136个国家。
            ...
            # Four questions
            questions = [
                "#### 质疑一：你为什么会信任一个"监管者"的投资能力？\n\n**市场监管能力 ≠ 资产管理能力。** 这就像你认为"顶级裁判"一定是"顶级球员"一样荒谬。",
                
                "#### 质疑二：你为什么会相信一条"不可能存在"的回报曲线？\n\n15年稳定在10-12%的收益？连巴菲特在熊市都会亏损超过30%！一条几十年"不回调"的收益曲线，在统计学上只有一种可能：**庞氏骗局。**",
                
                "#### 质疑三：你为什么会接受一个完全不透明的"黑盒子"？\n\n**真正的投资大师分享的是原则和哲学，而骗子才需要绝对的黑盒来隐藏他们的空无一物。**",
                
                "#### 质疑四：你为什么会让"别人"替你思考？\n\n当所有人都依赖他人的判断时，这不是"集体智慧"，而是"集体催眠"。**连这些世界顶级的聪明人都被骗了，你凭什么认为自己能幸免？**"
            ]
